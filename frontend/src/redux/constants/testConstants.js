...
export const TEST_DSP_REQUEST = 'TEST_DSP_REQUEST';
export const TEST_DSP_SUCCESS = 'TEST_DSP_SUCCESS';
export const TEST_DSP_FAIL = 'TEST_DSP_FAIL';
export const TEST_DSP_RESET = 'TEST_DSP_RESET';
